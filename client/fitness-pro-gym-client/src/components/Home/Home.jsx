    ...
    <>
        ...
        <main className="first-main">
            ...
            <div>
                ...
                {/* <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1195.2618190729377!2d23.29687476688384!3d42.66513715308453!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40aa84ee6f0e1c3f%3A0x7cf4bf6cf4fba837!2sFitness%20Pro%20Gym!5e0!3m2!1sbg!2sbg!4v1697479912228!5m2!1sbg!2sbg" width="600" height="450" style="border:0;" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe> */}
            </div>
        </main>
        ...
        <main className="first-main">
            ...
            <div className="image-wrapper">
                <img src="./images/main-room.jpg" alt=""/>
            </div>
        </main>

        <main className="second-main">
            <div className="image-wrapper">
                <img src="./images/secondRoom.jpg" alt=""/>
            </div>
